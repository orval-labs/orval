...
export const useListPets = <TError = Promise<Error>>(
  ...
  const swrFn = () => listPets(params, version, fetchOptions);
...
export const useCreatePets = <TError = Promise<Error>>(
  ...
  const swrFn = getCreatePetsMutationFetcher(params, version, fetchOptions);
...
export const useShowPetById = <TError = Promise<Error>>(
  ...
  const swrFn = () => showPetById(petId, version, fetchOptions);
...
export const useDeletePetById = <TError = Promise<Error>>(
  ...
  const swrFn = getDeletePetByIdMutationFetcher(petId, version, fetchOptions);
...
export const useShowPetWithOwner = <TError = Promise<Error>>(
  ...
  const swrFn = () => showPetWithOwner(petId, version, fetchOptions);
