 ...
 * @summary List all pets
 */
export const useListPetsSuspense = <TError = Promise<Error>>(
  params: ListPetsParams,
  options?: {
    swr?: SWRConfiguration<Awaited<ReturnType<typeof listPets>>, TError> & {
      swrKey?: Key;
 ...
 * @summary Info for a specific pet
 */
export const useShowPetByIdSuspense = <TError = Promise<Error>>(
  petId: string,
  options?: {
    swr?: SWRConfiguration<Awaited<ReturnType<typeof showPetById>>, TError> & {
      swrKey?: Key;
 ...
 * @summary health check
 */
export const useHealthCheckSuspense = <TError = Promise<Error>>(options?: {
  swr?: SWRConfiguration<Awaited<ReturnType<typeof healthCheck>>, TError> & {
    swrKey?: Key;
    enabled?: boolean;
  };
 ...
 * @summary combinate nullable and $ref
 */
export const useShowPetWithOwnerSuspense = <TError = Promise<Error>>(
  petId: string,
  options?: {
    swr?: SWRConfiguration<
      Awaited<ReturnType<typeof showPetWithOwner>>,
