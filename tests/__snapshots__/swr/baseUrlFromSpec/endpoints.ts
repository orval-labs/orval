...
export const getCreatePetUrl = () => {
  return `https://pets.example.com/pets`;
};
...
export const createPet = async (
  ...
  const data: createPetResponse['data'] =
...
export const getCreatePetMutationKey = () =>
  [`https://pets.example.com/pets`] as const;
...
export const getGetEchoUrl = () => {
  return `https://eu.echo.api.dev.example.com/ping`;
};
...
export const getEcho = async (
  ...
  const data: getEchoResponse['data'] =
    body !== null ? JSON.parse(body) : undefined;
  return { data, status: res.status, headers: res.headers } as getEchoResponse;
};

export const getGetEchoKey = () =>
  [`https://eu.echo.api.dev.example.com/ping`] as const;
