...
export function listItemsResource(
  options: OrvalHttpResourceOptions<ItemOutput[], unknown, true> & {
    defaultValue: NoInfer<ItemOutput[]>;
  },
): HttpResourceRef<ItemOutput[]>;
export function listItemsResource(
  options?: OrvalHttpResourceOptions<ItemOutput[], unknown, true>,
...
export function listItemsResource(
  ...
  return httpResource<ItemOutput[]>(
...
export function listNamedItemsResource(
  options: OrvalHttpResourceOptions<ItemsOutput, unknown, true> & {
    defaultValue: NoInfer<ItemsOutput>;
  },
): HttpResourceRef<ItemsOutput>;
export function listNamedItemsResource(
  options?: OrvalHttpResourceOptions<ItemsOutput, unknown, true>,
): HttpResourceRef<ItemsOutput | undefined>;
export function listNamedItemsResource(
  options?: OrvalHttpResourceOptions<ItemsOutput, unknown, true>,
): HttpResourceRef<ItemsOutput | undefined> {
  return httpResource<ItemsOutput>(
