...
export class SwaggerPetstoreService {
  ...
  > {
    ...
    if (options?.observe === 'events') {
      return this.http
        .get<PetsOutput>(`${this.baseUrl}/pets`, {
  ...
  > {
    ...
    if (options?.observe === 'events') {
      return this.http
        .post<PetOutput>(`${this.baseUrl}/pets`, createPetsBody, {
          ...(options as Omit<NonNullable<typeof options>, 'observe'>),
          observe: 'events',
          params: filteredParams,
        })
  ...
  > {
    if (options?.observe === 'events') {
      return this.http
        .get<PetOutput>(`${this.baseUrl}/pets/${petId}`, {
          ...(options as Omit<NonNullable<typeof options>, 'observe'>),
          observe: 'events',
        })
        .pipe(
  ...
  > {
    if (options?.observe === 'events') {
      return this.http
        .get<PetWithTagOutput>(`${this.baseUrl}/pets/${petId}/owner`, {
          ...(options as Omit<NonNullable<typeof options>, 'observe'>),
          observe: 'events',
        })
        .pipe(
