...
export class Issue3705AngularQueryObjectSerializationStyleExplodeService {
  private readonly http = inject(HttpClient);
  searchCatalog<TData = CatalogItem[]>(
  ...
  searchCatalog<TData = CatalogItem[]>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`/catalog-items`, {
  ...
  searchCatalogComma<TData = CatalogItem[]>(
    params?: SearchCatalogCommaParams,
    options?: HttpClientBodyOptions,
  ): Observable<TData>;
  searchCatalogComma<TData = CatalogItem[]>(
    params?: SearchCatalogCommaParams,
  ...
  searchCatalogComma<TData = CatalogItem[]>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`/catalog-items/comma`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
        params: filteredParams,
      });
  ...
  searchCatalogDeepObject<TData = CatalogItem[]>(
    params?: SearchCatalogDeepObjectParams,
    options?: HttpClientBodyOptions,
  ): Observable<TData>;
  searchCatalogDeepObject<TData = CatalogItem[]>(
    params?: SearchCatalogDeepObjectParams,
  ...
  searchCatalogDeepObject<TData = CatalogItem[]>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`/catalog-items/deep-object`, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
        params: filteredParams,
      });
