...
export const invalidateListPets = async (
  ...
  await queryClient.invalidateQueries(
    {
      queryKey: customQueryOptions({ queryKey: getListPetsQueryKey(params) })
        .queryKey,
    },
    options,
  );
...
export const invalidateShowPetById = async (
  ...
  await queryClient.invalidateQueries(
    {
      queryKey: customQueryOptions({ queryKey: getShowPetByIdQueryKey(petId) })
        .queryKey,
    },
    options,
  );
...
export const invalidateHealthCheck = async (
  ...
  await queryClient.invalidateQueries(
    {
      queryKey: customQueryOptions({ queryKey: getHealthCheckQueryKey() })
        .queryKey,
    },
    options,
  );
