...
import { customQueryKey } from '../../../mutators/custom-query-key';
...
export const getShowPetByIdQueryKey = (petId: string) =>
  customQueryKey({ petId }, { url: `/pets/${petId}` });
...
>(options?: {
  ...
  const queryKey = customQueryKey({}, { url: `/health`, queryOptions });
...
export const getShowPetWithOwnerQueryKey = (petId: string) =>
  customQueryKey({ petId }, { url: `/pets/${petId}/owner` });
...
>(
  ...
  const queryKey = customQueryKey(
    { petId },
    { url: `/pets/${petId}/owner`, queryOptions },
  );
