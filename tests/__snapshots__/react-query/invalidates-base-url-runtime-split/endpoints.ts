...
export const getListPetsUrl = (params: ListPetsParams) => {
  ...
  return stringifiedParams.length > 0
    ? `${process.env.API_URL}/pets?${stringifiedParams}`
    : `${process.env.API_URL}/pets`;
};
...
export const getListPetsQueryKey = (params?: ListPetsParams) => {
  return [process.env.API_URL, 'pets', ...(params ? [params] : [])] as const;
};
  ...
  const onSuccess = (
    ...
    if (!options?.skipInvalidation) {
      queryClient.invalidateQueries({
        queryKey: [process.env.API_URL, 'pets'],
      });
    }
...
export const getShowPetByIdUrl = (petId: string) => {
  return `${process.env.API_URL}/pets/${petId}`;
};
...
export const getHealthCheckQueryKey = () => {
  return [process.env.API_URL, 'health'] as const;
};
...
export const getShowPetWithOwnerUrl = (petId: string) => {
  return `${process.env.API_URL}/pets/${petId}/owner`;
};
...
export const getShowPetWithOwnerQueryKey = (petId: string) => {
  return [process.env.API_URL, 'pets', petId, 'owner'] as const;
};
