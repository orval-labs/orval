...
import { customQueryOptionsWithOperation } from '../../../mutators/custom-query-options-with-operation';
...
>(
  ...
  const customOptions = customQueryOptionsWithOperation(
...
export const invalidateListPets = async (
  ...
  await queryClient.invalidateQueries(
    {
      queryKey: customQueryOptionsWithOperation(
