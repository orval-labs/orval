 ...
 * @summary Info for a specific pet
 */
export const useGetShowPetByIdQueryData = () => {
  const queryClient = useQueryClient();
  return (petId: string) =>
    queryClient.getQueryData<Awaited<ReturnType<typeof showPetById>>>(
      getShowPetByIdQueryKey(petId),
    );
};
 ...
 * @summary health check
 */
export const useGetHealthCheckQueryData = () => {
  const queryClient = useQueryClient();
  return () =>
    queryClient.getQueryData<Awaited<ReturnType<typeof healthCheck>>>(
 ...
 * @summary combinate nullable and $ref
 */
export const useGetShowPetWithOwnerQueryData = () => {
  const queryClient = useQueryClient();
  return (petId: string) =>
    queryClient.getQueryData<Awaited<ReturnType<typeof showPetWithOwner>>>(
      getShowPetWithOwnerQueryKey(petId),
    );
};
