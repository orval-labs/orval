 ...
 * @summary List all pets
 */
export const prefetchListPetsQuery = async <TData = Awaited<ReturnType<typeof listPets>>, TError = Error>(
 queryClient: QueryClient, params: ListPetsParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof listPets>>, TError, TData>>, fetch?: RequestInit}
...
export const createPets = async (createPetsBody: CreatePetsBody,
    params: CreatePetsParams, options?: RequestInit): Promise<createPetsResponse> => {
...
export const getCreatePetsMutationOptions = <TError = Error,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createPets>>, TError,{data: CreatePetsBody;params: CreatePetsParams}, TContext>, fetch?: RequestInit}
): UseMutationOptions<Awaited<ReturnType<typeof createPets>>, TError,{data: CreatePetsBody;params: CreatePetsParams}, TContext> => {
 ...
 * @summary Info for a specific pet
 */
export const prefetchShowPetByIdQuery = async <TData = Awaited<ReturnType<typeof showPetById>>, TError = Error>(
 queryClient: QueryClient, petId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof showPetById>>, TError, TData>>, fetch?: RequestInit}
 ...
 * @summary health check
 */
export const prefetchHealthCheckQuery = async <TData = Awaited<ReturnType<typeof healthCheck>>, TError = Error>(
 queryClient: QueryClient,  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof healthCheck>>, TError, TData>>, fetch?: RequestInit}
 ...
 * @summary combinate nullable and $ref
 */
export const prefetchShowPetWithOwnerQuery = async <TData = Awaited<ReturnType<typeof showPetWithOwner>>, TError = Error>(
 queryClient: QueryClient, petId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof showPetWithOwner>>, TError, TData>>, fetch?: RequestInit}
