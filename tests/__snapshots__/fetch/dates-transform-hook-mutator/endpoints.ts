...
import { useCustomFetch } from '../../../mutators/use-custom-fetch';
...
export const useGetOrderDetailsHook = (): ((
  orderId: string,
  ...
  return (
    ...
    return customFetcher(getGetOrderDetailsUrl(orderId), {
      ...options,
      method: 'GET',
    }).then((value) => {
...
export const useGetPetProfileHook = (): ((
  petId: string,
  options?: Parameters<ReturnType<typeof useCustomFetch>>[1],
  ...
  return (
    ...
    return customFetcher(getGetPetProfileUrl(petId), {
      ...options,
      method: 'GET',
    }).then((value) => {
...
export const useGetAuditRecordHook = (): ((
  auditId: string,
  options?: Parameters<ReturnType<typeof useCustomFetch>>[1],
  ...
  return (
    ...
    return customFetcher(getGetAuditRecordUrl(auditId), {
      ...options,
      method: 'GET',
    }).then((value) => {
...
export const useListShelterPetsHook = (): ((
  shelterId: string,
  options?: Parameters<ReturnType<typeof useCustomFetch>>[1],
  ...
  return (
    ...
    return customFetcher(getListShelterPetsUrl(shelterId), {
      ...options,
      method: 'GET',
    }).then((value) => {
...
export const useListOrderNumbersHook = (): ((
  options?: Parameters<ReturnType<typeof useCustomFetch>>[1],
) => Promise<listOrderNumbersResponse>) => {
  const customFetcher = useCustomFetch();
  return (options?: Parameters<ReturnType<typeof useCustomFetch>>[1]) => {
    return customFetcher(getListOrderNumbersUrl(), {
      ...options,
      method: 'GET',
    });
  };
...
export const useUpdateAppointmentHook = (): ((
  ...
  return (
    ...
    return customFetcher(getUpdateAppointmentUrl(), {
      ...options,
      method: 'PUT',
      headers: {
...
export const useUpdateAppointmentDuplicateDateHook = (): ((
  ...
  return (
    ...
    return customFetcher(getUpdateAppointmentDuplicateDateUrl(), {
      ...options,
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
...
export const useUpdateAppointmentReminderHook = (): ((
  ...
  return (
    ...
    return customFetcher(getUpdateAppointmentReminderUrl(appointmentId), {
      ...options,
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json',
...
export const useUpdateShelterIntakeHook = (): ((
  shelterId: string,
  ...
  return (
    ...
    return customFetcher(getUpdateShelterIntakeUrl(shelterId), {
      ...options,
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
...
export const useUpdateShelterRecordsHook = (): ((
  shelterId: string,
  ...
  return (
    ...
    return customFetcher(getUpdateShelterRecordsUrl(shelterId), {
      ...options,
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
      ...
      const res = value as updateShelterRecordsResponse;
      if (res.status === 200) {
...
export const useUpdateAppointmentWindowHook = (): ((
  appointmentId: string,
  ...
  return (
    ...
    return customFetcher(getUpdateAppointmentWindowUrl(appointmentId), {
      ...options,
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
      ...
      const res = value as updateAppointmentWindowResponse;
      if (res.status === 200) {
