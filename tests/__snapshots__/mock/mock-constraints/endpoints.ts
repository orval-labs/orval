...
export const getGetItemsResponseMock = (
  ...
  maxLengthLargeVariable: faker.helpers.arrayElement([
    faker.string.alpha({ length: { min: 10, max: 50 } }),
    undefined,
  ]),
  minLengthSmallVariable: faker.helpers.arrayElement([
    faker.string.alpha({ length: { min: 5, max: 20 } }),
    undefined,
  ]),
  maxLengthZero: faker.helpers.arrayElement([
    faker.string.alpha({ length: { min: 0, max: 0 } }),
    undefined,
  ]),
