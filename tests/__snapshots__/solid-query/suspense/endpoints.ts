...
>(
  ...
  const query = useQuery(
    () => getListPetsSuspenseQueryOptions(params, options),
    queryClient,
  );
...
>(
  ...
  const query = useInfiniteQuery(
    () => getListPetsSuspenseInfiniteQueryOptions(params, options),
    queryClient,
  );
...
>(
  ...
  const query = useQuery(
    () => getShowPetByIdSuspenseQueryOptions(petId, options),
    queryClient,
  );
...
>(
  ...
  const query = useQuery(
    () => getHealthCheckSuspenseQueryOptions(options),
    queryClient,
  );
...
>(
  ...
  const queryOptions = getShowPetWithOwnerSuspenseQueryOptions(petId, options);

  const query = useQuery(
    () => getShowPetWithOwnerSuspenseQueryOptions(petId, options),
    queryClient,
  );
