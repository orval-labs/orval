...
export default defineConfig({
  ...
  ndJsonAggregated: {
    output: {
      target: '../generated/fetch/nd-json-aggregated/endpoints.ts',
      schemas: '../generated/fetch/nd-json-aggregated/model',
      client: 'fetch',
      override: {
        fetch: {
          ndJson: {
  ...
  ndJsonHalfAggregated: {
    output: {
      target: '../generated/fetch/nd-json-half-aggregated/endpoints.ts',
      schemas: '../generated/fetch/nd-json-half-aggregated/model',
      client: 'fetch',
      override: {
        fetch: {
          ndJson: {
  ...
  ndJsonNotAggregated: {
    output: {
      target: '../generated/fetch/nd-json-not-aggregated/endpoints.ts',
      schemas: '../generated/fetch/nd-json-not-aggregated/model',
      client: 'fetch',
      override: {
        fetch: {
          ndJson: {
