...
export default defineConfig({
  ...
  strictMode: {
    output: {
      target: '../generated/zod/strict-mode/strict-mode.ts',
      client: 'zod',
      override: {
        zod: {
          strict: {
  ...
  coerce: {
    output: {
      target: '../generated/zod/coerce/coerce.ts',
      client: 'zod',
      override: {
        zod: {
          coerce: {
  ...
  preprocess: {
    output: {
      target: '../generated/zod/preprocess/preprocess.ts',
      client: 'zod',
      override: {
        zod: {
          preprocess: {
  ...
  dateTimeOptions: {
    output: {
      target: '../generated/zod/date-time-options/date-time-options.ts',
      client: 'zod',
      override: {
        zod: {
          dateTimeOptions: {
  ...
  timeOptions: {
    output: {
      target: '../generated/zod/time-options/time-options.ts',
      client: 'zod',
      override: {
        zod: {
          timeOptions: {
  ...
  // The validator's view of the typeless parts: `instanceof(Blob)` here has to
  // agree with the `Blob | File` the type generator emits (#4157).
  'typeless-content-keywords': {
    output: {
      target: '../generated/zod/typeless-content-keywords/endpoints.ts',
      schemas: '../generated/zod/typeless-content-keywords/model',
      client: 'zod',
      clean: true,
      formatter: 'prettier',
    },
