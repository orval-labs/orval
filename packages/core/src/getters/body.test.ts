...
describe('getBody', () => {
  ...
  describe('isBlob detection', () => {
    ...
    it('sets isBlob to true for text/csv with an octet-stream schema', () => {
      const requestBody: OpenApiRequestBodyObject = {
        content: {
          'text/csv': {
            schema: {
    ...
    it('sets isBlob to true for */* with an inline octet-stream schema', () => {
      const requestBody: OpenApiRequestBodyObject = {
        content: {
          '*/*': {
            schema: {
    ...
    it('sets isBlob to true for $ref to an octet-stream schema', () => {
      const context = createContext();
      context.spec.components = {
        ...context.spec.components,
        schemas: {
