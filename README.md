...
- `orval import --input MY_OPENAPI_SPEC.yaml --output my-awesome-generated-types.tsx`
...
```diff
      "scripts": {
        ...
        "build": "webpack -p",
+       "generate-fetcher": "orval import --input MY_SWAGGER_DOCS.json --output FETCHERS.tsx"
      }
```
...
Using an url in input like this `orval import --input https://github.com/OAI/OpenAPI-Specification/blob/master/examples/v3.0/petstore.yaml` allows us to **create your client from an OpenAPI spec _remotely hosted on GitHub._** <sup>_(how is this real life_ 🔥 _)_</sup>
...
1.  Open a terminal and run `orval import --input https://github.com/OAI/OpenAPI-Specification/blob/master/examples/v3.0/petstore.yaml`, substituting things where necessary.
