...
export const useListPets = <TData = AsyncReturnType<typeof listPets>, TError = Error>(
...
): UseQueryStoreResult<AsyncReturnType<typeof listPets>, TError, TData, QueryKey> & {
	queryKey: QueryKey;
} => {
	...
	const queryFn: QueryFunction<AsyncReturnType<typeof listPets>> = ({ signal }) =>
		listPets(params, version, signal);

	const query = useQuery<AsyncReturnType<typeof listPets>, TError, TData>(queryKey, queryFn, {
		enabled: !!version,
		...queryOptions
	});
...
export const useShowPetById = <TData = AsyncReturnType<typeof showPetById>, TError = Error>(
...
): UseQueryStoreResult<AsyncReturnType<typeof showPetById>, TError, TData, QueryKey> & {
	queryKey: QueryKey;
} => {
	const { query: queryOptions } = options ?? {};
	...
	const queryFn: QueryFunction<AsyncReturnType<typeof showPetById>> = ({ signal }) =>
		showPetById(petId, version, signal);

	const query = useQuery<AsyncReturnType<typeof showPetById>, TError, TData>(queryKey, queryFn, {
