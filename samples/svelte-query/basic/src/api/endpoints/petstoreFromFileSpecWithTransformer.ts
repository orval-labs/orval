...
export const getListPetsQueryOptions = <TData = Awaited<ReturnType<typeof listPets>>, TError = Error>(params?: ListPetsParams,
    version: number = 1, options?: { query?:CreateQueryOptions<Awaited<ReturnType<typeof listPets>>, TError, TData>, }
) => {
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListPetsQueryKey(params,version);
   ...
   return  { queryKey, queryFn, enabled: !!(version), ...queryOptions} as CreateQueryOptions<Awaited<ReturnType<typeof listPets>>, TError, TData> & { queryKey: QueryKey }
}
...
export function createListPets<TData = Awaited<ReturnType<typeof listPets>>, TError = Error>(
 params?: ListPetsParams,
    version: number = 1, options?: { query?:CreateQueryOptions<Awaited<ReturnType<typeof listPets>>, TError, TData>, }
...
export const getCreatePetsMutationOptions = <TError = Error,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof createPets>>, TError,{data: CreatePetsBody;version?: number}, TContext>, }
 ...
 * @summary Create a pet
 */
export const createCreatePets = <TError = Error,
    TContext = unknown>(options?: { mutation?:CreateMutationOptions<Awaited<ReturnType<typeof createPets>>, TError,{data: CreatePetsBody;version?: number}, TContext>, }
 ): CreateMutationResult<
...
export const getShowPetByIdQueryOptions = <TData = Awaited<ReturnType<typeof showPetById>>, TError = Error>(petId: string,
    version: number = 1, options?: { query?:CreateQueryOptions<Awaited<ReturnType<typeof showPetById>>, TError, TData>, }
) => {
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getShowPetByIdQueryKey(petId,version);
   ...
   return  { queryKey, queryFn, enabled: !!(version && petId), ...queryOptions} as CreateQueryOptions<Awaited<ReturnType<typeof showPetById>>, TError, TData> & { queryKey: QueryKey }
}
...
export function createShowPetById<TData = Awaited<ReturnType<typeof showPetById>>, TError = Error>(
 petId: string,
    version: number = 1, options?: { query?:CreateQueryOptions<Awaited<ReturnType<typeof showPetById>>, TError, TData>, }
