...
export class PetsService {
  ...
  updatePetById(
    ...
    if (accept.includes('json') || accept.includes('+json')) {
      return this.http.put<Pet>(`/pets/${petId}/update`, pet, {
        ...options,
        responseType: 'json',
        headers,
      });
    } else if (accept.startsWith('text/') || accept.includes('xml')) {
      return this.http.put(`/pets/${petId}/update`, pet, {
        ...options,
        responseType: 'text',
        headers,
      }) as Observable<string>;
  ...
  patchPetById(
    ...
    if (accept.includes('json') || accept.includes('+json')) {
      return this.http.patch<Pet>(`/pets/${petId}/update`, pet, {
        ...options,
        responseType: 'json',
        headers,
      });
    } else if (accept.startsWith('text/') || accept.includes('xml')) {
      return this.http.patch(`/pets/${petId}/update`, pet, {
        ...options,
        responseType: 'text',
        headers,
      }) as Observable<string>;
