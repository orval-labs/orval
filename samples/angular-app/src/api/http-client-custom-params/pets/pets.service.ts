 ...
 */
 listPets(accept: 'application/json',
  ...
  listPets(accept?: ListPetsAccept,
    params?: ListPetsParams,
    version?: number, options?: HttpClientOptions): Observable<Pets | string>;
  listPets(
    ...
    const filteredParams = paramsSerializerMutator(filterParams({...params, ...options?.params}, new Set<string>([])));
 ...
 */
 showPetById(petId: string,
  ...
  showPetById(petId: string,
    ...
    version?: number, options?: HttpClientOptions): Observable<Pet | string>;
  showPetById(
    petId: string,
