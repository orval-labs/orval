...
import { CreatePetsBody, Pet, Pets } from '../model';
import type {
  ListPetsParams,
  PetOutput,
  PetsOutput,
...
export class PetsService {
  ...
  createPets<TData = void>(
    ...
    return defer(() => {
      ...
      return this.http.post<TData>(`/v${version}/pets`, parsedCreatePetsBody, {
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'body',
      });
    });
  ...
  updatePetById(
    ...
    return defer(() => {
      ...
      if (accept.includes('json') || accept.includes('+json')) {
        return this.http
          .put<PetOutput>(`/v${version}/pets/${petId}/update`, parsedPet, {
            ...options,
            responseType: 'json',
            headers,
          })
        ...
        return this.http.put(`/v${version}/pets/${petId}/update`, parsedPet, {
          ...options,
          responseType: 'text',
          headers,
        }) as Observable<string>;
  ...
  patchPetById(
    ...
    return defer(() => {
      const parsedPet = pet === undefined ? undefined : Pet.parse(pet);
      const headers =
        options?.headers instanceof HttpHeaders
          ? options.headers.set('Accept', accept)
          : { ...(options?.headers ?? {}), Accept: accept };
      ...
      if (accept.includes('json') || accept.includes('+json')) {
        return this.http
          .patch<PetOutput>(`/v${version}/pets/${petId}/update`, parsedPet, {
            ...options,
            responseType: 'json',
            headers,
          })
        ...
        return this.http.patch(`/v${version}/pets/${petId}/update`, parsedPet, {
          ...options,
          responseType: 'text',
          headers,
        }) as Observable<string>;
