...
export const getListPetsMock = () => (faker.helpers.randomize([[...Array(faker.datatype.number({min: 1, max: 10}))].map(() => ({id: faker.datatype.number(), name: (() => faker.name.lastName())(), tag: (() => faker.name.lastName())()})), {code: faker.datatype.number(), message: faker.random.word()}]))
