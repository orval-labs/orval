...
export class PetsService {
  ...
  private readonly baseUrl = inject(PETSTORE_BASE_URL);
  /**
  ...
  searchPets<TData = Pets>(
    ...
    if (options?.observe === 'events') {
      return this.http.get<TData>(`${this.baseUrl}/v${version}/search`, {
  ...
  listPets(
    ...
    if (accept.includes('json') || accept.includes('+json')) {
      ...
      return this.http.get(`${this.baseUrl}/v${version}/pets`, {
        ...options,
        responseType: 'text',
        headers,
        params: filteredParams,
  ...
  showPetById(
    ...
    if (accept.includes('json') || accept.includes('+json')) {
      ...
      return this.http.get(`${this.baseUrl}/v${version}/pets/${petId}`, {
        ...options,
        responseType: 'text',
        headers,
      }) as Observable<any>;
  ...
  updatePetById(
    ...
    if (accept.includes('json') || accept.includes('+json')) {
      return this.http.put<Pet>(
        `${this.baseUrl}/v${version}/pets/${petId}/update`,
        pet,
        {
          ...options,
          responseType: 'json',
  ...
  showPetText(
    ...
    if (options?.observe === 'events') {
      return this.http.get(`${this.baseUrl}/v${version}/pets/${petId}/text`, {
        responseType: 'text',
        ...(options as Omit<NonNullable<typeof options>, 'observe'>),
        observe: 'events',
  ...
  uploadFile<TData = void>(
    ...
    if (options?.observe === 'events') {
      return this.http.post<TData>(
        `${this.baseUrl}/v${version}/pet/${petId}/uploadImage`,
        uploadFileBody,
        {
          ...(options as Omit<NonNullable<typeof options>, 'observe'>),
          observe: 'events',
  ...
  downloadFile(
    ...
    if (options?.observe === 'events') {
      return this.http.get(
        `${this.baseUrl}/v${version}/pet/${petId}/downloadImage`,
        {
          responseType: 'blob',
          ...(options as Omit<NonNullable<typeof options>, 'observe'>),
          observe: 'events',
