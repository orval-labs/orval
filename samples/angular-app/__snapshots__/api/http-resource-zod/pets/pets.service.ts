...
export function showPetByIdResource(petId: Signal<string>,
    accept: 'text/plain',
    version?: Signal<number>,
    options?: OrvalHttpResourceOptions<string | Pet, unknown, true>): HttpResourceRef<string | undefined>;
export function showPetByIdResource(petId: Signal<string>,
...
export function showPetByIdResource(petId: Signal<string>,
    ...
    version?: Signal<number>,
    options?: OrvalHttpResourceOptions<string | Pet, unknown, true>): HttpResourceRef<Pet | undefined>;
export function showPetByIdResource(
    petId: Signal<string>,
    accept?: ShowPetByIdAccept,
    version?: Signal<number>,
    options?: OrvalHttpResourceOptions<string | Pet, unknown, true>
  ...
  return (() => {
    ...
    if (accept.includes('json') || accept.includes('+json')) {
      return httpResource<Pet>(() => ({
        ...normalizedRequest,
        headers,
      }), options as unknown as OrvalHttpResourceOptions<Pet, unknown, true>);
    }
