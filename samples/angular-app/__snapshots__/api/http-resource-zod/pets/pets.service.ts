...
export function showPetByIdResource(petId: Signal<string>,
    version: Signal<number> | undefined,
  options: OrvalHttpResourceOptions<string | Pet, unknown> & { defaultValue: NoInfer<string | Pet> }): HttpResourceRef<string | Pet>;
export function showPetByIdResource(petId: Signal<string>,
    version?: Signal<number>,
  options?: OrvalHttpResourceOptions<string | Pet, unknown>): HttpResourceRef<string | Pet | undefined>;
export function showPetByIdResource(petId: Signal<string>,
    version?: Signal<number>,
  options?: OrvalHttpResourceOptions<string | Pet, unknown>): HttpResourceRef<string | Pet | undefined> {
  return httpResource<string | Pet>(() => `/v${version?.() ?? 1}/pets/${petId()}`, options);
}
