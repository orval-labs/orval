...
export const listPets = async (params?: ListPetsParams, options?: RequestInit): Promise<Pets> => {
...
export const createPets = async (createPetsBody: CreatePetsBody, options?: RequestInit): Promise<Pet> => {
...
export const useCreatePets = <TError = Promise<Error>>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof createPets>>, TError, Key, CreatePetsBody, Awaited<ReturnType<typeof createPets>>> & { swrKey?: string }, fetch?: RequestInit}
) => {
