...
export const getListPetsMock = () => ([...Array(faker.datatype.number({min: 1, max: 10}))].map(() => ({'@id': faker.helpers.randomize([faker.random.word(), undefined]), id: (()=>import_faker.faker.datatype.number({min:1,max:99999}))(), name: (()=>import_faker.faker.name.lastName())(), tag: (()=>import_faker.faker.name.lastName())(), email: faker.helpers.randomize([faker.internet.email(), undefined])})))

export const getCreatePetsMock = () => ({'@id': faker.helpers.randomize([faker.random.word(), undefined]), id: faker.datatype.number(), name: (()=>import_faker.faker.name.lastName())(), tag: (()=>import_faker.faker.name.lastName())(), email: faker.helpers.randomize([faker.internet.email(), undefined])})
