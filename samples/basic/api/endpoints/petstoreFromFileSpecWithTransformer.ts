...
export const getListPetsMockHandler = (overrideResponse?: PetsArray) => {
  return http.get('*/v:version/pets', async () => {
    await delay(1000);
    return new HttpResponse(JSON.stringify(overrideResponse !== undefined ? overrideResponse : getListPetsResponseMock()),
      {
        status: 200,
        headers: {
...
export const getListPetsNestedArrayMockHandler = (overrideResponse?: PetsNestedArray) => {
  return http.get('*/v:version/pets-nested-array', async () => {
    await delay(1000);
    return new HttpResponse(JSON.stringify(overrideResponse !== undefined ? overrideResponse : getListPetsNestedArrayResponseMock()),
      {
        status: 200,
        headers: {
          'Content-Type': 'application/json',
...
export const getShowPetByIdMockHandler = (overrideResponse?: Pet) => {
  return http.get('*/v:version/pets/:petId', async () => {
    await delay(1000);
    return new HttpResponse(JSON.stringify(overrideResponse !== undefined ? overrideResponse : getShowPetByIdResponseMock()),
      {
        status: 200,
        headers: {
          'Content-Type': 'application/json',
