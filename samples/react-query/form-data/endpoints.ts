 ...
 */
const listPets = (params?: ListPetsParams) => {
  return customInstance<PetsArray>({ url: `/pets`, method: 'GET', params });
};
 ...
 */
const createPets = (createPetsBody: CreatePetsBody) => {
 ...
 */
const listPetsNestedArray = (params?: ListPetsNestedArrayParams) => {
 ...
 */
const showPetById = (petId: string) => {
  return customInstance<Pet>({ url: `/pets/${petId}`, method: 'GET' });
};
