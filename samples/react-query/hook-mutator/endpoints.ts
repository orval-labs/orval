...
export const listPets = async (
  ...
  return useCustomInstance<listPetsResponse>(getListPetsUrl(params), {
    ...options,
    method: 'GET',
  });
};
...
export const createPets = async (
  ...
  return useCustomInstance<createPetsResponse>(getCreatePetsUrl(), {
    ...options,
    method: 'POST',
...
export const listPetsNestedArray = async (
  ...
  return useCustomInstance<listPetsNestedArrayResponse>(
...
export const showPetById = async (
  ...
  return useCustomInstance<showPetByIdResponse>(getShowPetByIdUrl(petId), {
    ...options,
    method: 'GET',
  });
};
