...
const useListPetsHook = () => {
  ...
  return useCallback(
    (params?: ListPetsParams, version: number = 1) => {
      return listPets({ url: `/v${version}/pets`, method: 'GET', params });
    },
    [listPets],
  );
};
...
const useListPetsNestedArrayHook = () => {
  ...
  return useCallback(
    (params?: ListPetsNestedArrayParams, version: number = 1) => {
...
const useShowPetByIdHook = () => {
  ...
  return useCallback(
    (petId: string, version: number = 1) => {
      return showPetById({ url: `/v${version}/pets/${petId}`, method: 'GET' });
    },
    [showPetById],
  );
};
