...
export const listPetsResponseItem = zod.preprocess(stripNill, zod.discriminatedUnion('breed', [zod.object({
  "cuteness": zod.number(),
...
export const createPetsResponse = zod.preprocess(stripNill, zod.discriminatedUnion('breed', [zod.object({
  "cuteness": zod.number(),
  "breed": zod.enum(['Labradoodle'])
}).strict(),zod.object({
  "length": zod.number(),
...
export const updatePetsResponse = zod.preprocess(stripNill, zod.discriminatedUnion('breed', [zod.object({
  "cuteness": zod.number(),
  "breed": zod.enum(['Labradoodle'])
}).strict(),zod.object({
  "length": zod.number(),
...
export const showPetByIdResponse = zod.preprocess(stripNill, zod.discriminatedUnion('breed', [zod.object({
  "cuteness": zod.number(),
  "breed": zod.enum(['Labradoodle'])
}).strict(),zod.object({
  "length": zod.number(),
