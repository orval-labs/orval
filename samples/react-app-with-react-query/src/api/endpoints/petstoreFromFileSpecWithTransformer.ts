...
export const useCreatePets = (
  ...
  return useMutation<AxiosResponse<unknown>, AxiosError, CreatePetsBody>(
    (createPetsBody: CreatePetsBody, version: number = 1) =>
      axios.post(`/v${version}/pets`, createPetsBody),
    mutationConfig,
  );
};
