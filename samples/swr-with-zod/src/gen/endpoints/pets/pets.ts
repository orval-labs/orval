...
export const getListPetsUrl = (params?: ListPetsParams,) => {
  ...
  return stringifiedParams.length > 0 ? `http://localhost:8000/pets?${stringifiedParams}` : `http://localhost:8000/pets`
}
...
export const getListPetsKey = (params?: ListPetsParams,) => [`http://localhost:8000/pets`, ...(params ? [params]: [])] as const;
...
export const useListPets = <TError = Promise<unknown>>(
  params?: ListPetsParams, options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof listPets>>, TError> & { swrKey?: Key, enabled?: boolean }, fetch?: RequestInit }
) => {
...
export type createPetsResponseComposite = createPetsResponse200 | createPetsResponseDefault;
...
export const getCreatePetsMutationFetcher = ( options?: RequestInit) => {
  return (_: Key, { arg }: { arg: CreatePetsBodyItem[] }): Promise<createPetsResponse> => {
    return createPets(arg, options);
  }
}
export const getCreatePetsMutationKey = () => [`http://localhost:8000/pets`] as const;
...
export const useCreatePets = <TError = Promise<Error>>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof createPets>>, TError, Key, CreatePetsBodyItem[], Awaited<ReturnType<typeof createPets>>> & { swrKey?: string }, fetch?: RequestInit}
) => {
...
export type updatePetsResponseComposite = updatePetsResponse200 | updatePetsResponseDefault;
...
export const updatePets = async (pet: NonReadonly<Pet>, options?: RequestInit): Promise<updatePetsResponse> => {
...
export const getUpdatePetsMutationFetcher = ( options?: RequestInit) => {
  return (_: Key, { arg }: { arg: NonReadonly<Pet> }): Promise<updatePetsResponse> => {
    return updatePets(arg, options);
  }
}
export const getUpdatePetsMutationKey = () => [`http://localhost:8000/pets`] as const;
 ...
 * @summary Update a pet
 */
export const useUpdatePets = <TError = Promise<Error>>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof updatePets>>, TError, Key, NonReadonly<Pet>, Awaited<ReturnType<typeof updatePets>>> & { swrKey?: string }, fetch?: RequestInit}
) => {
...
export type showPetByIdResponseComposite = showPetByIdResponse200 | showPetByIdResponseDefault;
...
export const getShowPetByIdKey = (petId: string,) => [`http://localhost:8000/pets/${petId}`] as const;
...
export const useShowPetById = <TError = Promise<Error>>(
  petId: string, options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof showPetById>>, TError> & { swrKey?: Key, enabled?: boolean }, fetch?: RequestInit }
) => {
  const {swr: swrOptions, fetch: fetchOptions} = options ?? {}
