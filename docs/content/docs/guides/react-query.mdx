...
Pass `undefined` for query params or body to update every cached entry that shares the same path — useful when a mutation should patch a record across all filter/pagination variants:
