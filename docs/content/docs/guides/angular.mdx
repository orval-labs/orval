...
`override.angular.client` to choose which Angular output mode Orval should
generate.
...
Use `override.angular.client` to choose the generated Angular output mode:
...
Enable the `httpResource` output mode with `override.angular.client`.
