...
Format generated files with [oxfmt](https://oxc.rs/docs/guide/usage/formatter):
...
<Callout type="warn">
`--prettier`, `--biome`, and `--oxfmt` are mutually exclusive. Only one can be specified at a time.
</Callout>
