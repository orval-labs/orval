...
import { ConfigFields } from '../../../../src/components/config-fields';
import { override } from '../../../../src/generated/config-reference/override';
...
<ConfigFields section={override} name="header" />
