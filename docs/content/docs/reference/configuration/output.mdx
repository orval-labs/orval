...
The callback receives `info`, the [OpenAPI Info Object](https://github.com/OAI/OpenAPI-Specification/blob/main/versions/3.1.1.md#info-object). Its fields:

<ConfigReference path="output.override.header" />
...
<ConfigReference path="output.override.query" />
...
<ConfigReference path="output.override.swr.useInfinite" />

### useSWRMutationForGet

<ConfigReference path="output.override.swr.useSWRMutationForGet" />

### useSuspense

<ConfigReference path="output.override.swr.useSuspense" />

### generateErrorTypes

<ConfigReference path="output.override.swr.generateErrorTypes" />

### swrOptions

<ConfigReference path="output.override.swr.swrOptions" />

### swrMutationOptions

<ConfigReference path="output.override.swr.swrMutationOptions" />

### swrInfiniteOptions

<ConfigReference path="output.override.swr.swrInfiniteOptions" />
...
The callback receives `operation`, the [OpenAPI Operation Object](https://github.com/OAI/OpenAPI-Specification/blob/main/versions/3.1.1.md#operation-object):

<ConfigReference path="output.override.operationName" />
