...
The transformer callback receives `spec`, the parsed [OpenAPI Document](https://github.com/OAI/OpenAPI-Specification/blob/main/versions/3.1.1.md#openapi-object):

<ConfigReference path="input.override.transformer" />
