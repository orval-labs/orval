...
## 4. Moved `paramsSerializerOptions` under `override.axios`

Since this is an axios-specific feature, we consolidated axios-related settings under `override.axios`.

### How to maintain compatibility

Move the setting under `override.axios`.
